...
public class HealthPotion : MonoBehaviour, IDroppable
{
    ...
    [SerializeField] bool moveToLifeUI = true;
    [CanShow("moveToLifeUI", NOT = true)] [SerializeField] Vector3 movement2 = Vector3.down;
    ...
    IEnumerator AnimationDestroyCoroutine()
    {
        ...
        //movement 2 (reach life slider, or movement2)
        currentTime = 0;
        delta = 0;
        startPosition = transform.position;
        endPosition = moveToLifeUI && GameManager.instance.uiManager.SliderHealth ? GameManager.instance.uiManager.SliderHealth.transform.position : transform.position + movement2;
        ...
        while (delta < 1)
        {
            ...
            if (moveToLifeUI && GameManager.instance.uiManager.SliderHealth)
                endPosition = GameManager.instance.uiManager.SliderHealth.transform.position;
