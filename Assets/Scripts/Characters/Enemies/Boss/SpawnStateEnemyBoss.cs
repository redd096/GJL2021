...
public class SpawnStateEnemyBoss : StateMachineBehaviour
{
    ...
    [SerializeField] bool callSpawnStateEvent = true;
    ...
    //
    //when enter state call also enemy.onSpawnState event
    //
    ...
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        //call state event
        if (callSpawnStateEvent)
            enemy.onSpawnState?.Invoke();
    }
